package com.kakao.example.android.util;
...
/**
 * ImageLoader
 * Image download and Memory/Disk(LRU) caching
 */
public class ImageLoader {
	...
	private void initImageWorker() {
		...
		thumbnailImageWorker.setLoadingImage(R.drawable.image_profile_default_blue); // default thumbnail image
